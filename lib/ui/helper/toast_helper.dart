import 'package:chat_wave/constant/rescode.dart';
...
class ToastHelper {
  ...
  static void showToasterWithRescode(int resCode){
    AppNotification notification = ResCode.getCorNotification(resCode);
