...
extension UserByIndex on IsarCollection<User> {
  Future<User?> getByUserId(int userId) {
    return getByIndex(r'userId', [userId]);
  }

  User? getByUserIdSync(int userId) {
  ...
  Future<List<User?>> getAllByUserId(List<int> userIdValues) {
    final values = userIdValues.map((e) => [e]).toList();
    return getAllByIndex(r'userId', values);
  }

  List<User?> getAllByUserIdSync(List<int> userIdValues) {
    final values = userIdValues.map((e) => [e]).toList();
...
extension UserQueryWhere on QueryBuilder<User, User, QWhereClause> {
  ...
  QueryBuilder<User, User, QAfterWhereClause> userIdGreaterThan(
    int userId, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<User, User, QAfterWhereClause> userIdLessThan(
    int userId, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
